  ...
  return (
    <section id="services" className="services-section min-h-screen bg-gray-900 flex flex-col items-center py-16 px-4 md:ml-64 snap-start relative overflow-hidden">
      ...
      <style jsx>{`
        ...
        .services-card:hover { box-shadow: 0 25px 50px rgba(0,0,0,0.4); }
        .services-timeline-dot { border-color: #111827; }
        .services-icon-box { background: rgba(55, 65, 81, 0.5); }
        .services-card-title { color: #ffffff; }
        .services-card-desc { color: #9ca3af; }
        .services-feature-title { color: #ffffff; }
        .services-feature-item { color: #d1d5db; }
        .services-btn {
        ...
        :global(html:not(.dark)) .services-card {
          background: rgba(255, 255, 255, 0.9) !important;
          border-color: #e5e7eb !important;
          box-shadow: 0 4px 20px rgba(0,0,0,0.06) !important;
        }
        :global(html:not(.dark)) .services-card:hover {
        ...
        :global(html:not(.dark)) .services-feature-title { color: #111827 !important; }
        :global(html:not(.dark)) .services-feature-item { color: #374151 !important; }
        :global(html:not(.dark)) .services-btn {
          border-color: #d1d5db !important;
          color: #374151 !important;
          background: transparent !important;
        }
        :global(html:not(.dark)) .services-cta-box {
          background: rgba(255, 255, 255, 0.7) !important;
          border: 1px solid #e5e7eb !important;
        }
        :global(html:not(.dark)) .services-cta-title { color: #111827 !important; }
        :global(html:not(.dark)) .services-cta-text { color: #4b5563 !important; }
      `}</style>
    </section>
  );
};
